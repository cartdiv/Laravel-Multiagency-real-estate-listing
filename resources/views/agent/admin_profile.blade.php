          ...
          <div class="position-relative">
            ...
            <div class="d-flex justify-content-between align-items-center position-absolute top-90 w-100 px-2 px-md-4 mt-n4">
              ...
              <div class="d-none d-md-block">
                <a href="{{route('edit.agent.profile')}}" class="btn btn-primary btn-icon-text">
            ...
            <div class="d-flex align-items-center justify-content-between mb-2">
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  <a class="dropdown-item d-flex align-items-center" href="{{route('edit.profile')}}"><i data-feather="edit-2" class="icon-sm me-2"></i> <span class="">Edit</span></a>
                </div>
              </div>
            </div>
            <p>{{$admin_data->address}}</p>
            <div class="mt-3">
