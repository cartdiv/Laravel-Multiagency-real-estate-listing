                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-[30px] mb-[-30px]">
                    ...
                    <div class="mb-[30px]">
                        ...
                        <div>
                            ...
                            <h3><a href="blog-details.html" class="font-recoleta text-[22px] xl:text-[28px] leading-[1.285] text-primary block mb-[10px] hover:text-secondary transition-all">{{ $item->blog_name }}</a></h3>
